...
.factory('activationstateFactory', function(){
    var factory={
        statenotification:false,
        activatenotification: function(){
            factory.statenotification =true;
        },
        deactivatenotification:function(){
            factory.statenotification=false;
        }
    }
...
.controller("NotificationController", ['$scope','juronsFactory','activationstateFactory' function($scope, $cordovaLocalNotification) {
            ...
            if(now <= treizeam){
                $cordovaLocalNotification.schedule({
                  ...
                  every: 'minute'
                      ...
                      acivationstateFactory.activatenotification();
                });
            }else{
    ...
    $scope.isScheduled = function() {
        ...
        $scope.activation=acivationstateFactory.statenotification;
    };
    ...
    $scope.desactiver = function(){
      $cordovaLocalNotification.cancelAll().then(function(cancelAll){
          ...
          acivationstateFactory.deactivatenotification();
      }); 
    };
